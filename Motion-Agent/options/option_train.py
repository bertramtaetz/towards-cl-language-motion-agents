...
def get_args_parser():
    ...
    ## LLM 
    parser.add_argument('--llm-backbone', type=str, default=BACKBONE, help='name of huggingface model backbone')
    ...
    ## output directory 
    parser.add_argument('--out-dir', type=str, default=str(_PROJECT_ROOT / 'experiments'), help='output directory')
    ...
    ## email notifications
    parser.add_argument('--notify-emails', type=str, default=None, 
                        help='Comma-separated list of email addresses for training notifications (e.g., "user@example.com,advisor@example.com")')
    parser.add_argument('--notify-interval', type=int, default=10, 
                        help='Send email notification every N epochs (default: 10, ~2 hours)')
    parser.add_argument('--notify-sender', type=str, default=None,
                        help='Sender email address for notifications (must be verified in AWS SES). Defaults to first email in --notify-emails')
