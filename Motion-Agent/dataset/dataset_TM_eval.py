...
class Text2MotionDataset(data.Dataset):
    def __init__(self, dataset_name, type, w_vectorizer, feat_bias = 5, max_text_len = 20, unit_length = 4):
        ...
        if dataset_name == 't2m':
            ...
            self.meta_dir = str(PRETRAINED / 'checkpoints/t2m/VQVAEV3_CB1024_CMT_H1024_NRES3/meta')
            ...
            self.meta_dir = str(PRETRAINED / 'checkpoints/kit/VQVAEV3_CB1024_CMT_H1024_NRES3/meta')
