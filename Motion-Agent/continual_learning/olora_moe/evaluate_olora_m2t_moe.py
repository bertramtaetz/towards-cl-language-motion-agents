"""O-LoRA MoE M2T Evaluation -- task-id free routing.
...
def evaluate_stage(
    ...
    output = {
        ...
        "split": split,
        "evaluation_protocol": "TM2T (nlgeval multi-ref), O-LoRA MoE (task-id free routing)",
...
def parse_args():
    p = argparse.ArgumentParser(description="O-LoRA MoE M2T Evaluation")
...
def main():
    ...
    print("=" * 70)
    print("O-LoRA MoE M2T Evaluation (task-id free)")
    print("=" * 70)
