> Companion-specific installation: install this local directory, not a separate upstream package. Resources are under pretrained/nlg. Java 21 fails the current SPICE scorer; the upstream Java guidance below is not a validated compatibility guarantee. See the root docs/INSTALLATION.md and docs/VALIDATION.md.
