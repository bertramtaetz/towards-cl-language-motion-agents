    ...
    if not no_overlap:
        ...
        for scorer, method in scorers:
            ...
            if isinstance(method, list):
                ...
                # SPICE is optional and may be unavailable (e.g. missing external jars).
                # In that case, the scorer returns NaN; do not include it in returned metrics.
                if method != 'SPICE' or (score is not None and not (isinstance(score, float) and math.isnan(score))):
